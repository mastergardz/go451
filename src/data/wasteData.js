...
export const criteria = [
  {
    ...
    maxScore: 2,
    description: 'มีเอกสารมาตรการจัดการขยะ 4 ด้านครบถ้วน: (1) ลดปริมาณขยะ (2) คัดแยกขยะตามบริบทสำนักงาน (3) นำขยะกลับมาใช้ประโยชน์ใหม่ (4) กำจัดขยะอย่างถูกต้องและเหมาะสม รวมถึงการจัดการขยะอิเล็กทรอนิกส์ — พร้อมสื่อสารให้พนักงานรับทราบ',
  ...
  },
  {
    ...
    maxScore: 2,
    description: 'บันทึกน้ำหนักขยะแยกประเภท (อย่างน้อย 4 ประเภท หรือตามบริบทสำนักงาน) ครบถ้วนทุกเดือน พร้อมวิเคราะห์เปรียบเทียบกับเป้าหมายที่กำหนดในหมวด 1 (อนุโลมใช้ยอดสะสมรอบไตรมาส หรือยอดสะสมรวมได้)',
  ...
  },
  {
    ...
    maxScore: 2,
    description: 'นำขยะทุกประเภทที่สามารถนำกลับมาใช้ใหม่หรือสร้างประโยชน์ได้ > 45% = 2 คะแนนเต็ม | 30-45% + สิ่งประดิษฐ์/นวัตกรรมจากพัสดุที่ไม่ใช้งานอย่างน้อย 1 ชิ้น = 2 คะแนน | 20-30% = 1 คะแนน | < 20% = 0 คะแนน',
    keywords: ['Reuse/Recycle > 45%', 'สิ่งประดิษฐ์', 'นวัตกรรม', 'ลดภาระฝังกลบ'],
    evidence: 'สูตร: (ปริมาณขยะที่นำกลับมาใช้ใหม่สะสม × 100) ÷ ปริมาณขยะทั้งหมดทุกประเภทสะสม + หลักฐานสิ่งประดิษฐ์ (กรณี 30-45%)',
    icon: '♻️',
    color: '#1B5E20',
    bgColor: '#E8F5E9',
  },
  {
    ...
    maxScore: 2,
    description: 'จุดวางถังขยะเพียงพอ สภาพดี ป้ายบ่งชี้ประเภทชัดเจน + มีจุดพักขยะก่อนส่งกำจัด (Centralized Waste Area) + สุ่มตรวจสอบถัง/จุดพักขยะ อย่างน้อย ไตรมาสละ 1 ครั้ง + สุ่มตรวจพฤติกรรมการทิ้งขยะของพนักงาน อย่างน้อย เดือนละ 1 ครั้ง พร้อมบันทึกสาเหตุและแนวทางแก้ไข',
  ...
  },
  {
    ...
    maxScore: 2,
    description: 'มีระบบบำบัดน้ำเสียเหมาะสมกับลักษณะน้ำเสีย (ตะแกรงดักเศษอาหาร, ถังดักไขมัน, ถังบำบัดสำเร็จรูป, บ่อเกรอะ) + ดูแลรักษาสม่ำเสมอ ไม่ชำรุด + จัดการเศษอาหาร/ไขมัน/ตะกอนถูกต้อง + หากพื้นที่อาคาร ≥ 5,000 ตร.ม. ต้องมีรายงานผลตรวจวัดน้ำทิ้งตามกฎหมาย',
  ...
  },
  {
    ...
    maxScore: 4,
    description: 'สุ่มสัมภาษณ์พนักงานอย่างน้อย 5 คน ต้องตอบได้ครอบคลุม 5 หัวข้อ: การลดปริมาณขยะ, การคัดแยกขยะ, การนำขยะกลับมาใช้ประโยชน์ใหม่, การจัดการน้ำเสีย (ใช้ผลิตภัณฑ์ทำความสะอาดที่เป็นมิตรกับสิ่งแวดล้อม, กวาดเศษอาหารก่อนล้าง ฯลฯ) — เกณฑ์: ตอบได้ 5 คน = 4 คะแนน, 4 คน = 3, 3 คน = 2, 2 คน = 1, ตอบไม่ได้ = 0',
